...
> *A bug-fix patch: auto-connect belts no longer vanish when you turn off distributor chaining, Smart! now plays nice with Infinite Nudge's mouse-wheel rotation, blueprints with auto-connected power poles work on dedicated servers, Zoop mode no longer eats your scaled grid, wall pipe supports get their panel settings back, and the hyper tube length error tells the truth.*
