...
- **Scaled pipeline supports follow height AND angle** - The standard Pipeline Support is a two-step buildable (place, then height) with an adjustable vertical angle on its top piece for sloped pipe runs. Scaling a line or grid of them now mirrors both to every copy: adjust the parent's height or tilt and the whole line follows, in single-player and multiplayer. (Part of Issues #291/#364)
