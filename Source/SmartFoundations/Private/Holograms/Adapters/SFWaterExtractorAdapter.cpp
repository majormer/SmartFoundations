...
FVector FSFWaterExtractorAdapter::CalculateWaterExtractorSize() const
{
	...
	{
		UE_LOG(LogSmartHologram, Verbose, TEXT("FSFWaterExtractorAdapter::CalculateWaterExtractorSize - Invalid hologram"));
	...
	if (!BuildClass)
	{
		UE_LOG(LogSmartHologram, Verbose, TEXT("FSFWaterExtractorAdapter: No BuildClass"));
		return USFBuildableSizeRegistry::GetDefaultSize();
	}
