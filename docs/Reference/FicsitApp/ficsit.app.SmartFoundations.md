...
- **Auto-connect works in Creative Mode** — with No Build Cost on (now under Creative Mode in 1.2), auto-connected belts, pipes, and power are no longer blocked as "unaffordable" and build for free, the same as base-game building.
